#define NGX_CONFIGURE " --prefix=/home/mukesh/nginx_delay_license_build --with-debug --add-module=/home/mukesh/Documents/nginx_delay_license/nginx1/nginx/nginx-custom-delay-module"
...
#ifndef NGX_HAVE_DASH_PARSER
#define NGX_HAVE_DASH_PARSER  1
#endif


#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/mukesh/nginx_delay_license_build/"
#endif
